...
> Chapter review state: **REVIEWED** — Step 5 independent source-grounding review completed 2026-07-17; material findings corrected (Step 6); chapter merged to main. The standalone review report was **not preserved as an artifact** — flagged at the liability-side integration gate (2026-07-17) for a follow-up focused review; see `reviews/interest-expense/liability-side-integration.review.md`. Approved content is never silently overwritten.
> Working basis: `research/source-briefs/interest-expense/deposits/ie_dom_time_dep.source-brief.md` (revised and approved 2026-07-17), which holds the full input/assumption registers and traceability table. Specification: `specifications/interest-expense/deposits/ie_dom_time_dep.yaml` (created at integration, 2026-07-17).
