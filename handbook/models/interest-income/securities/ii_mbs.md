...
| Blank amortized cost (not near-settle) | Config `missing_ac_mode`: `price_proxy_no_accretion` (default, unchanged behavior) \| `price_proxy_accrete` \| `zero_accrete` (blank read as zero and accreted — the reference's own treatment, reproduces its row to −0.0001) | **PID-SEC-13, user-directed 2026-07-28**; rationale and evidence in `handbook/open-questions.md`; owners' confirmation pending as **OQ-031** |
