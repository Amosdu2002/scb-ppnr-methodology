...
- **[PID-TRD-1]** Calibration mode (§9) — user-confirmed 2026-08-13 at the Increment 4 gate. **[PID-TRD-2]** Physical inputs (§3.1) and the FRB-provided β source (§3.3) — user-supplied same day. **[PID-TRD-3]** Annualized-÷4 basis (§5/§8/§9) — observed on the user-supplied trading-tab screenshot same day. Registered in `handbook/open-questions.md`.
...
| D-002 (superseded 2026-08-13), D-005, D-006, D-007, D-008 conventions; PID-TRD-1/2/3; PID-OB-5 (mirrored pattern) | `handbook/open-questions.md` decision log; user confirmations 2026-08-13 (§3.1, §9, §11 — gate Q&A + supplied cells + trading-tab screenshot) |
