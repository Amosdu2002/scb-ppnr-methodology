...
**PID-LOAN-30 (registered in `handbook/open-questions.md`):** the user supplied the family's construction ("Here's how they constructed it") and its rate source. As observed — arithmetic-verified on a consumer row — with no firm values entering this repository:
