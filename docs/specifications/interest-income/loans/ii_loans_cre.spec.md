...
> Fed-side methodology lives in `docs/handbook/models/ii_loans_cre.source-brief.md` (APPROVED 2026-08-12) and its common/wholesale parents. PIDs are registered canonically in `docs/handbook/open-questions.md`.
