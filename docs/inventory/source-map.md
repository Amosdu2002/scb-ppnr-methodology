...
Conventions (established in `docs/inventory/source-integrity-review.md`):
...
- Model IDs refer to `docs/inventory/model-inventory.md`.
...
| — | Retail | sec-156, line 3503 | 177 | 4 retail sections; segmentation drivers; loan-level + segment-level data basis (complete sentence — contrast SQ-5). Owner: `docs/handbook/models/ii_loans_retail.source-brief.md` (framework, drafted 2026-08-12) | ii_loans |
| — | Mortgage | sec-157, line 3511 | 177–178 | HFI/FVO-HFS × FRM/ARM; rejected extra segmentation [ALT]; base-rate boundary for FRM/fixed-HEL new originations = OQ-040. Owner: `docs/handbook/models/ii_loans_mortgage.source-brief.md` (drafted 2026-08-12) | ii_loans |
| — | Auto Loan | sec-158, line 3520 | 178 | Y-14Q Schedule A.2 segment level (schedule absent from the p. 172 suite list — recorded contrast); all fixed-rate; HFS→HFI reclass; new/used; Prime-based spread (measurement = OQ-042). Owner: `docs/handbook/models/ii_loans_auto.source-brief.md` (drafted 2026-08-12) | ii_loans |
| — | Consumer and Small Business Credit Card | sec-159, line 3530 | 178–179 | Bank/charge cards ("the alternative model" — SQ-25); all variable; revolver classification (A156); three-input projected spread with no stated formula (OQ-043); rate and spread reported in Y-14M; OQ-012. Owner: `docs/handbook/models/ii_loans_card.source-brief.md` (drafted 2026-08-12) | ii_loans |
| — | Other Consumer Products | sec-160, line 3545 | 179–180 | No segmentation; jump-off rate from Y-14Q PPNR line-item report (OQ-011); spread vs. Prime; engine assignment vs the sec-164 expert-judgment split = OQ-041; all international consumer products sit here. Owner: `docs/handbook/models/ii_loans_other_consumer.source-brief.md` (drafted 2026-08-12) | ii_loans |
...
| — | Fixed-Rate Products | sec-165, line 3606 | 182–183 | **Eqs A34–A38** (A34/A35/A36/A38 print no firm subscript — SQ-18/OQ-033); "the Prime Rate for retail" abbreviates away the mortgage exception (SQ-23); median origination date (t−a); wt from default/prepay/maturity | ii_loans |
| — | Industry Scalar | sec-166, line 3648 | 183–184 | True-up scalar; footnote 63 | ii_loans |
| — (c) | Model Assumptions and Limitations (+ Assumptions / Limitations / Retail / Wholesale) | sec-167…171, lines 3659–3729 | 184–186 | Assumptions (1)–(7) incl. quarterly compounding; Retail Portfolio limitations = the Prime-except-mortgages rule + non-core/auto data limits ("retails" — SQ-24; owner: retail framework brief §12); NPML proxy ("farm" here vs. "farmland" p. 175 — SQ-19); no revolver-draw growth (stated under Wholesale) | ii_loans |
...
- Table A6 net-interest rows: 10 structural + 2 regression = **12 components**; + the cross-cutting hedge adjustment (v.c) = **13 PRIMARY items**, matching the 13 records in `docs/inventory/model-inventory.md` and the PRIMARY sections in §4 above.
