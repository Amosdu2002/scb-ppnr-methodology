...
`docs/architecture/interest-expense-design.md`; the roadmap and gate decisions live in
`docs/inventory/asset-side-model-matrix.md`, the methodology conventions in
`docs/handbook/cross-cutting/asset-side-common-conventions.md`.
