...
**Review date: 2026-07-23.** Reviewer: this session, against the authoritative PDF page images (PPNR pp. 196–198 opened and read in full; MRM pp. 18–20 — the vendor-model passage — opened and read in full; A41 spelling settled via the PDF text layer). Remaining prose (pp. 195, 199–200) verified against the md working copy (fidelity per `docs/inventory/source-integrity-review.md` §4/§9).
Files under review: `docs/handbook/models/interest-income/securities/ii_mbs.md`, `docs/specifications/interest-income/securities/ii_mbs.yaml`.
...
1. `docs/handbook/open-questions.md`: **OQ-026** filed; OQ-004 resolved.
