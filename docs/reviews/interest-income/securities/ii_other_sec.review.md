...
**Review date: 2026-07-23.** Reviewer: this session, against the authoritative PDF page images (PPNR pp. 201–203 opened and read in full; p. 205 previously image-verified at Increment 1; A42 spelling settled via a PDF **text-layer glyph-count check** — the decisive new evidence this session). Remaining prose (pp. 200, 204) verified against the md working copy (fidelity per `docs/inventory/source-integrity-review.md` §4/§9).
Files under review: `docs/handbook/models/interest-income/securities/ii_other_sec.md`, `docs/specifications/interest-income/securities/ii_other_sec.yaml`.
...
1. `docs/inventory/source-integrity-review.md`: **SQ-8 refined; CA-4 filed**; §9 coverage updated (pp. 191–193, 196–198, 201–203 images; text-layer method documented); §11 extended (MRM pages image-verified; extracts file).
2. `docs/handbook/open-questions.md`: OQ-004 resolved; OQ-025 filed (shared).
