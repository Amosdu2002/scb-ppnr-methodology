...
1. `docs/handbook/open-questions.md`: OQ-004 resolved; **OQ-025** and **OQ-027** filed.
2. `docs/handbook/cross-cutting/asset-side-common-conventions.md` §12: securities shared machinery added.
3. `sources/fed/market-risk-models-securities-extracts.md`: scoped second-source working copy created.
4. `docs/inventory/asset-side-model-matrix.md` and `docs/inventory/source-integrity-review.md`: status and verification-coverage updates.
