...
> chaptered cite the approved `docs/inventory/model-inventory.md` records (#1–#6, #11) and are extended
> at each family increment. Navigation: `docs/inventory/asset-side-model-matrix.md`. Decisions cited
...
`docs/handbook/cross-cutting/liability-side-common-conventions.md` §8).
...
- **Revised 2026-08-13 (Increment 4 gate — PID-TRD-1, user-confirmed; not a silent overwrite,
  ...
  sibling income models (registry: `docs/handbook/open-questions.md`; chapter §9). Consequences:
...
- **Input granularity [PID-SEC-1, user-confirmed 2026-07-23]:**
  **security-level.** The firm holds full security-level data for every
  ...
  Companion confirmations (registry in `docs/handbook/open-questions.md`):
