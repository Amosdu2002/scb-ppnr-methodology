...
> Chapter review state: **REVIEWED** — Step 5 independent source-grounding review completed 2026-07-17; material findings corrected (Step 6); chapter merged to main. The standalone review report was **not preserved as an artifact** — flagged at the liability-side integration gate (2026-07-17) for a follow-up focused review; see `docs/reviews/interest-expense/liability-side-integration.review.md`. Approved content is never silently overwritten.
> Working basis: `docs/handbook/models/interest-expense/deposits/ie_dom_time_dep.source-brief.md` (revised and approved 2026-07-17), which holds the full input/assumption registers and traceability table. Specification: `docs/specifications/interest-expense/deposits/ie_dom_time_dep.yaml` (created at integration, 2026-07-17).
...
- Cross-reference: the cross-cutting hedge chapter (planned, `docs/handbook/cross-cutting/`) will own Equations A49–A51 in full.
...
- **OQ-005 — OPEN.** Division of hedge-adjustment responsibility across components if the proposed FR Y-14Q B.2/B.3 collection proceeds; §8 presents both data states. (`docs/handbook/open-questions.md`)
...
| PID-1…PID-6 project decisions; D-004 convention | User confirmations 2026-07-17; `docs/handbook/open-questions.md` decision log; brief §0.1 |
