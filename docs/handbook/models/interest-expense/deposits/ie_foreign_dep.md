...
> Chapter review state: **REVIEWED** — independent PDF-grounding review passed 2026-07-17, source-faithful as drafted (`docs/reviews/interest-expense/deposits/ie_foreign_dep.review.md`). Specification: `docs/specifications/interest-expense/deposits/ie_foreign_dep.yaml`.
...
- [PID-6/D-004] Annualized-rate convention and final-step ÷4 (decision log, `docs/handbook/open-questions.md`).
...
| D-004 ÷4 convention; PID-5 MEV pattern | `docs/handbook/open-questions.md` decision log; `ie_dom_time_dep.md` §3.2 |
