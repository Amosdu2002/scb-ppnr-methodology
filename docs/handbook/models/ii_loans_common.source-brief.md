...
> Verification: **PDF pp. 173–188 read as page images 2026-07-30** (full fresh pass; §9 of `docs/inventory/source-integrity-review.md` updated); equations A32–A38 and Table A8 previously verified 2026-07-16. Citation format: (PDF p. N; md sec-M).
...
| **[OQ]** | OPEN QUESTION | Linked to `docs/handbook/open-questions.md` by ID |
...
- Coding-friendly identifier (per `docs/inventory/model-inventory.md` record #1): **`ii_loans`**.
...
| 30 | New quirks SQ-18/SQ-19/SQ-20; new OQ-033/034/035 | filing record | 175–186 | sec-153–171 | — | Filed 2026-07-30 (`docs/inventory/source-integrity-review.md` §8/§9; `docs/handbook/open-questions.md`) |
