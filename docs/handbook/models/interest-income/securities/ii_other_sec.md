...
> Chapter review state: **DRAFTED + source-grounding review this session (`docs/reviews/interest-income/securities/ii_other_sec.review.md`) — AWAITING USER REVIEW (Increment 2 gate).** Specification: `docs/specifications/interest-income/securities/ii_other_sec.yaml`.
