...
| 3 | C (loans) | `ii_loans` (one chapter, six portfolio sections per D-003) | **IN PROGRESS — wholesale COMPLETE, retail R1 drafted.** Slice 1 (common + wholesale briefs) APPROVED 2026-08-03; slice 2 Corporate brief APPROVED 2026-08-12, engine **converged vs the company reference (grand 0.9979)**, PID-LOAN-1..17; slice 3 CRE brief APPROVED 2026-08-12, engine **converged (round 2 grand 1.0006)**, PID-LOAN-18..25 (round-3 grand line owed for the spec record). **Retail slices per the approved 2026-08-12 plan (order: framework+Auto bundled → Mortgage → Card → Other Consumer): R1 briefs DRAFTED 2026-08-12** (`ii_loans_retail` framework + `ii_loans_auto`), awaiting the user gate; SQ-23/24 + OQ-040/041/042 filed. Standing gate decisions for the remaining families: retail wt delivery (OQ-001); retail floors (OQ-002); retail scalar rows incl. SME cards (OQ-010); other-consumer jump-off mapping + engine assignment (OQ-011/OQ-041); revolver-share input (OQ-012). Wholesale integration review still owed (D-010(a)) |
...
| `ii_loans` | Source briefs (D-010; chapter later per D-003): `handbook/models/ii_loans_common.source-brief.md` + `ii_loans_wholesale` — **APPROVED 2026-08-03**; `ii_loans_corporate` + `ii_loans_cre` — **APPROVED 2026-08-12**; `ii_loans_retail` + `ii_loans_auto` — **DRAFTED 2026-08-12, awaiting user gate**; mortgage/card/other-consumer briefs per gate order | `specifications/interest-income/loans/ii_loans_corporate.spec.md` (converged 0.9979); `ii_loans_cre.spec.md` (converged 1.0006, round-3 record owed); retail specs follow each family gate | User gates: slices 1–3 passed (2026-08-03 / 2026-08-12 ×2); retail R1 pending |
