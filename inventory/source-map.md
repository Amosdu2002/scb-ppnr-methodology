...
| — | Retail | sec-156, line 3503 | 177 | 4 retail sections; segmentation drivers; loan-level + segment-level data basis (complete sentence — contrast SQ-5). Owner: `handbook/models/ii_loans_retail.source-brief.md` (framework, drafted 2026-08-12) | ii_loans |
| — | Mortgage | sec-157, line 3511 | 177–178 | HFI/FVO-HFS × FRM/ARM; rejected extra segmentation [ALT]; base-rate boundary for FRM/fixed-HEL new originations = OQ-040. Owner: `handbook/models/ii_loans_mortgage.source-brief.md` (drafted 2026-08-12) | ii_loans |
| — | Auto Loan | sec-158, line 3520 | 178 | Y-14Q Schedule A.2 segment level (schedule absent from the p. 172 suite list — recorded contrast); all fixed-rate; HFS→HFI reclass; new/used; Prime-based spread (measurement = OQ-042). Owner: `handbook/models/ii_loans_auto.source-brief.md` (drafted 2026-08-12) | ii_loans |
| — | Consumer and Small Business Credit Card | sec-159, line 3530 | 178–179 | Bank/charge cards ("the alternative model" — SQ-25); all variable; revolver classification (A156); three-input projected spread with no stated formula (OQ-043); rate and spread reported in Y-14M; OQ-012. Owner: `handbook/models/ii_loans_card.source-brief.md` (drafted 2026-08-12) | ii_loans |
| — | Other Consumer Products | sec-160, line 3545 | 179–180 | No segmentation; jump-off rate from Y-14Q PPNR line-item report (OQ-011); spread vs. Prime; engine assignment vs the sec-164 expert-judgment split = OQ-041; all international consumer products sit here. Owner: `handbook/models/ii_loans_other_consumer.source-brief.md` (drafted 2026-08-12) | ii_loans |
