...
| — | Mortgage | sec-157, line 3511 | 177–178 | HFI/FVO-HFS × FRM/ARM; rejected extra segmentation [ALT]; base-rate boundary for FRM/fixed-HEL new originations = OQ-040 (filed at the framework brief) | ii_loans |
...
| — | Consumer and Small Business Credit Card | sec-159, line 3530 | 178–179 | Bank/charge cards; all variable; revolver classification (A156); Prime + constant spread; rate and spread reported in Y-14M; OQ-012 | ii_loans |
| — | Other Consumer Products | sec-160, line 3545 | 179–180 | No segmentation; jump-off rate from Y-14Q PPNR line-item report (OQ-011); spread vs. Prime; engine assignment vs the sec-164 expert-judgment split = OQ-041; all international consumer products sit here | ii_loans |
